...
export const technologies: Technology[] = [
  {
    ...
    perexEn: 'Anatomy of an adhesive bond: adhesion versus cohesion, how the adhesive transfers load and why uniform stress distribution changes joint design.',
  ...
  },
  {
    ...
    perexEn: 'A strength × elongation diagram, a decision tree and the key parameters for matching an adhesive to substrate, environment and production.',
  ...
  },
  {
    ...
    perexCs: 'Kombinace chemické vazby a mechanické fixace překonává obě metody samostatně. Jak navrhovat weld-bonding a rivet-bonding v praxi.',
    perexEn: 'Combining chemical bonding with mechanical fastening beats either method alone. How to design weld-bonding and rivet-bonding in practice.',
    keywordsCs: ['hybridní spoje', 'weld-bonding', 'rivet-bonding', 'svar a lepení', 'nýt a lepení'],
  ...
  },
  {
    ...
    perexEn: '90% of bond failures are caused by surface preparation, not the adhesive. Three steps: mechanical cleaning, degreasing and activation.',
