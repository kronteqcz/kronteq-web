...
export const products: Product[] = [
  ...
  },
  {
    ...
    usesCs: ['Elektronické sestavy', 'Automobilové díly', 'Průmyslová výroba'],
  ...
  },
  {
    ...
    usesCs: ['Příprava kovových povrchů', 'Čištění plastů před lepením', 'Mezioperační čištění', 'Čisticí prostředky pro optiku'],
