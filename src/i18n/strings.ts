...
export const strings = {
  cs: {
    ...
    heroCta1: 'Naše služby',
    heroCta1Href: '/sluzby/',
    heroCta2: 'Nezávazná poptávka',
...
export function getLang(lang: string): Strings {
  return lang === 'en' ? strings.en : strings.cs;
}
